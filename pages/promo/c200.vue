<template>
  <div>
    <transition name="fade">
      <div id="c200Page" v-show="areFullLoaded">
...
title: "C200 | Box2box alquiler de trasteros a domicilio"
meta_description: "Aprovecha la promoción de alquiler de trasteros de box2box con C200. Almacenamiento seguro y excelentes tarifas en nuestros espacios. ¡Llámanos!"
feature_1_title: "Colaboración C200 con box2box"
feature_1_body: "
...
Además, como cliente de C200, recibirás una tarifa especial en todos los servicios de box2box.
...
<i18n lang="yaml" locale="es-en" src="@/i18n/views/c200Page.yaml"></i18n>
<i18n lang="yaml" locale="fr-en" src="@/i18n/views/c200Page.yaml"></i18n>
<i18n lang="yaml" locale="pt-en" src="@/i18n/views/c200Page.yaml"></i18n>
<i18n lang="yaml" locale="it-en" src="@/i18n/views/c200Page.yaml"></i18n>
