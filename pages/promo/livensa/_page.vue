<template>
  <div>
    ...
    <transition name="fade">
      <div id="livensaPage" v-show="areFullLoaded">
              ...
              >
                <div class="flex w-full justify-center pb-12">
                  <nuxt-img
                    ...
                    src="/promo/livensa/livensa.webp"
                    alt="livensa"
                    class="w-[194px]"
                  ></nuxt-img>
                </div>
...
export default {
  ...
  middleware({ store, params, redirect, app }) {
    ...
    const validRoutes =
      store.state.promoLivensa.routesPerSite[app.i18n.localeProperties.country];
    if (
      !validRoutes ||
...
title: "Pack Verano Livensa Residencias - box2box"
...
feature_1_title: "\"Pack de verano\" Livensa Residencias"
feature_1_body: "
...
Al ser residente en Livensa Residencias, ¡disfrutas de un
...
title: "Pack Verão Livensa Residências - box2box"
meta_description: "Aluga o teu armazém porta-a-porta para estudantes. Recohemos as tuas coisas, guardamos e devolvemos antes de começar o novo ano lectivo."
feature_1_title: "\"Pack Verão\" Residências  Livensa"
feature_1_body: "
A box2box oferece-te um serviço de armazenamento porta a porta
para estudantes, podendo armazenar até 20 objectos (caixas e malas). <br />
Como residente das Residências Livensa,
desfruta de um desconto exclusivo!
Ao reservar através da residência, não pagarás nada pelo transporte."
feature_2_title: "O que está incluído no \"pack de verão\"?"
feature_2_1: "Inventário digital"
feature_2_2: "Armazenamento para todo o verão"
feature_2_3: "Seguro que cobre até {amount}€"
feature_2_4: "Recogida en la residencia en las fechas indicadas"
feature_2_5: "Devolução dos artigos à mesma residência, nas datas indicadas"
feature_3: "O preço total para 3 meses de armazenagem è de <span class='text-electric'>{price}€</span>"
</i18n>
...
<i18n lang="yaml" locale="es-en" src="@/i18n/views/livensa/_page.yaml"></i18n>
<i18n lang="yaml" locale="fr-en" src="@/i18n/views/livensa/_page.yaml"></i18n>
<i18n lang="yaml" locale="pt-en" src="@/i18n/views/livensa/_page.yaml"></i18n>
<i18n lang="yaml" locale="it-en" src="@/i18n/views/livensa/_page.yaml"></i18n>
<i18n lang="yaml" locale="mx-en" src="@/i18n/views/livensa/_page.yaml"></i18n>
